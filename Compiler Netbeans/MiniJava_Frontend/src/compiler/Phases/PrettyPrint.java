...
public class PrettyPrint extends IRElementVisitor<Integer> {
    ...
    @Override
    public Integer visitStatement(MJStatementDecrement e) throws VisitorException {
        visitExpression(e.getExpr());
        pp.print(" ; ");
        return null;
    }
    ...
    @Override
    public Integer visitStatement(MJStatementIncrement e) throws VisitorException {
        visitExpression(e.getExpr());
        pp.print(" ; ");
        return null;
    }
    ...
    @Override
    public Integer visitStatement(MJTernary e) throws VisitorException {
        if (e.getIdent_opt() != null) {
            visitExpression(e.getIdent_opt());
        }
        visitExpression(e.getCondition());
        pp.print(" ? ");
        if (e.getIdent_a() != null) {
            visitExpression(e.getIdent_a());
        } else {
            visitExpression(e.getExpr_a());
        }
        pp.print(" : ");
        if (e.getIdent_b() != null) {
            visitExpression(e.getIdent_b());
        } else {
            visitExpression(e.getExpr_b());
        }
        pp.println("");
        return null;
    }
